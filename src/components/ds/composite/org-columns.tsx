 ...
 * (active = цветная рамка; sub-подпись с ФИО ответственного или «Не назначено»
 * красным) и кнопка «+ Добавить …».
 *
 * @example
 *   <OrgColumns columns={[
 *     { items: [{ label: "Отдел валидации", active: true }, { label: "Отдел документооборота" }], addLabel: "Добавить отдел" },
 *     { items: [{ label: "Сверка реквизитов пайщика", sub: "Козлова А. В.", active: true }, { label: "Выдача статуса «отвалидирован»", sub: "Не назначено", subTone: "danger" }], addLabel: "Добавить функцию" },
 *   ]} />
 */
