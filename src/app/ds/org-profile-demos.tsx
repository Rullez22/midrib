...
const ORG_GROUPS = [
  {
    heading: "Описание",
    text: "Потребительский кооператив «Immatra» объединяет пайщиков Санкт-Петербурга и Ленинградской области. Кооператив ведёт совместные закупки, содержание и благоустройство территорий, а также расчёты между пайщиками через лицевые счета.",
  },
  {
