    ...
    <SidebarShell>
      ...
      >
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-1 rounded-[4px] bg-surface-sunken px-4 py-1.5 transition-colors duration-[250ms] enabled:hover:bg-[color:var(--color-surface-hover)]"
        >
        ...
        <div className="flex w-full gap-[7px]">
          {accountsUnlocked ? (
            <button
              ...
              className={cn(
                "flex flex-1 items-center justify-center rounded-[4px] bg-surface-sunken p-2 transition-colors duration-[250ms] hover:bg-[color:var(--color-surface-hover)]",
