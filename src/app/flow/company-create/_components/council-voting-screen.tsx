 ...
 */
const ROSTER = [
  { last: "Дмитров", first: "Александр", patr: "Романович" }, // 0
  { last: "Александров", first: "Дмитрий", patr: "Александрович" }, // 1
  { last: "Курт", first: "Розалина", patr: "Артуровна" }, // 2
  { last: "Валенов", first: "Джо", patr: "Валенович" }, // 3
  { last: "Антонов", first: "Илья", patr: "Андреевич" }, // 4
];
