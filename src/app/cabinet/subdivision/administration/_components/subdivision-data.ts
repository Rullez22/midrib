...
export const INFO_GROUPS: InfoGroup[] = [
  {
    heading: "Описание",
    text: "Администрация — операционное подразделение потребительского кооператива «Immatra». Ведёт документооборот и делопроизводство, готовит и согласует договоры с партнёрами, организует заседания правления и совета, принимает и сопровождает новых пайщиков. Здесь же формируется отчётность по подразделениям и контролируются сроки по заявкам. В подразделении работают 20 пайщиков.",
  },
  {
...
export const CHARTER_ROWS = [
  ...
  { label: "Дата внесения в ЕГРПОО", value: "26.04.2018" },
];
...
export const ACHIEVEMENTS = [
  { logo: A1, title: "Пайщик года", org: "Никитин Павел Романович", date: "февраль 2025" },
  { logo: A2, title: "За вклад в развитие", org: "Морозов Виктор Николаевич", date: "сентябрь 2024" },
  { logo: A3, title: "Лучший наставник", org: "Зайцев Кирилл Олегович", date: "июнь 2022" },
];
