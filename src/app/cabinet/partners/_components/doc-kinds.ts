...
export const KINDS: Record<DocKind, KindConfig> = {
  ...
  invoice: {
    ...
    steps: [
      { tx: { action: "Подпись менеджера", role: "manager", date: "12.01.2020 - 12:00" }, chat: { text: "Подписал счет на оплату. Сейчас отправлю валидатору.", time: "12:01" } },
      { tx: { action: "Подпись валидатора", role: "validator", date: "12.01.2020 - 13:00" }, chat: { text: "Проверил и подписал. Вроде никаких замечаний нет. Все хорошо.", time: "13:00" } },
      { tx: { action: "Подпись менеджера", role: "manager", date: "12.01.2020 - 15:00" }, chat: { text: "Спасибо, подписал счет. Скоро оплачу.", time: "15:00" } },
    ],
  },
  act: {
    ...
    steps: [
      { tx: { action: "Подпись валидатора", role: "validator", date: "12.01.2020 - 12:00" }, chat: { text: "Привет, еще раз. Не возражаешь ?, я отправил валидатору.", time: "12:00" } },
      { tx: { action: "Подпись менеджера", role: "manager", date: "12.01.2020 - 13:00" }, chat: { text: "Спасибо, подписал акт. Все хорошо.", time: "13:00" } },
    ],
  },
  ...
  goalcontract: {
    ...
    signTxParty: "VELESTA",
    steps: [
      { tx: { action: "Подпись исполнителя", role: "executor", date: "11.01.2020 - 15:00" }, chat: { text: "Подписал договор со стороны исполнителя. Рады сотрудничеству.", time: "15:00" } },
    ],
  },
};
